...
<head>
    ...
    <title>POPULER4D - Situs Judol Teraman dan Terpercaya 2022</title>
...
<div class="container-fluid mx-auto text-center py-3" style="background:black;">
    <img src="{{ Storage::url($logos->file) }}" alt="" width="200" height="80">
</div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-center">
                ...
                <li class="nav-item">
                    <a href="http://165.22.60.6:9443/" class="nav-link text-white">
                        TOGEL
                    </a>
                </li>
                <li class="nav-item dropdown" style="font-family: 'Roboto', sans-serif;">
                    <a href="http://165.22.60.6:9443/" class="nav-link text-white">SLOT</a>
                </li>
                <li class="nav-item">
                    <a href="http://165.22.60.6:9443/" class="nav-link text-white">
                        CASINO
                ...
                <li class="nav-item">
                    <a href="http://165.22.60.6:9443/?content=promosi" class="nav-link text-white">
                        PROMOSI
                    </a>
                </li>
            </ul>
